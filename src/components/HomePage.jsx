  ...
  const tabContent = {
    ...
    contribute: {
      ...
      content: (
        <>
          <p className="mb-6">
            The spirit of open-source collaboration doesn't end with
            Hacktoberfest or any open source event. At TechNexus, we believe in
            fostering a community of continuous contribution. Your input shapes
            the future of our global tech community.
          </p>
          <p className="mb-6 text-lg font-semibold text-blue-300">
            Have a look at our superheroes empowering the tech space by their
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white font-sans p-8">
      ...
      >
        ...
        <p className="text-2xl mb-12 text-gray-300">
          Your Global Tech Event Hub by Dev Code Community
        </p>
        <div className="flex flex-col md:flex-row md:space-x-4 items-center justify-center space-y-4 md:space-y-0">
          <motion.a
          ...
          <Link href="/virtual-events" passHref>
            <motion.button
              whileHover={{
                scale: 1.05,
          ...
          {[
            {
              ...
              icon: "🔍",
              description:
                "Find exciting tech events happening around the globe.",
              clr: "#048727",
            },
            {
              title: "Connect",
            ...
            },
            {
              ...
              icon: "🚀",
              description:
                "Add events, share knowledge, and grow the community.",
              clr: "#f23a68",
            },
          ].map((item, index) => (
            <motion.div
              ...
              whileHover={{
                scale: 1.1,
                boxShadow: `${item.clr} 2px 2px 15px`,
                transition: { duration: 0.5 },
              }}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between px-8">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <p className="text-lg text-gray-300 mb-6">
              Dev Code Community is a passionate group of developers and tech
              enthusiasts dedicated to fostering growth, collaboration, and
              innovation in the tech world. Our mission is to create a
              supportive environment where members can learn, share knowledge,
              and contribute to exciting open-source projects like TechNexus.
            </p>
            <motion.a
      ...
      >
        ...
        >
          <motion.button
            whileHover={{
              scale: 1.05,
              boxShadow: "0px 0px 12px rgb(16, 185, 129)",
            }}
            whileTap={{ scale: 0.95 }}
